      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <section className="bg-slate-panel border border-slate-border rounded-2xl p-6 space-y-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-[10px] font-mono text-slate-500 uppercase tracking-widest mb-1.5 ml-1">Analyst Username</label>
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-black/20 border border-slate-border rounded-lg py-2 pl-10 pr-4 text-sm focus:outline-none focus:border-primary transition-all"
                />
              </div>
            </div>

            <div>
              <label className="block text-[10px] font-mono text-slate-500 uppercase tracking-widest mb-1.5 ml-1">Email Address</label>
              <div className="relative">
                <div className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500"><Mail size={14} /></div>
                <input 
                  type="email"
            ...
            <div>
              <label className="block text-[10px] font-mono text-slate-500 uppercase tracking-widest mb-1.5 ml-1">Display Name (Public Profile)</label>
              <div className="relative">
                <div className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500"><Globe size={14} /></div>
                <input 
                  type="text"
