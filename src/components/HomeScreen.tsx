    ...
    <div className="p-8 max-w-7xl mx-auto space-y-12 animate-in fade-in duration-700">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-slate-panel border border-slate-border p-12 flex flex-col items-center text-center">
        ...
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-1 rounded-full bg-primary/20 border border-primary/30 text-primary text-xs font-bold uppercase tracking-widest mb-6">
