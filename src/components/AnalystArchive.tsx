        ...
        <div className="flex gap-2">
          <div className="relative">
            ...
            <input 
              ...
              className="bg-slate-panel border border-slate-border rounded-lg py-2 pl-9 pr-4 text-xs w-64 focus:outline-none focus:border-primary transition-all"
            />
          </div>
              ...
              {filteredItems.map((item) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <div className="text-sm font-bold group-hover:text-primary transition-colors truncate max-w-[200px]">{item.input}</div>
                  </td>
                  <td className="px-6 py-4">
